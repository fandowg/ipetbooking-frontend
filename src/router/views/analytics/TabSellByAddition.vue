  ...
  methods: {
    ...
    getSummaries(param) {
        ...
        columns.forEach((column, index) => {
          ...
          const values = data.map(item => Number(item.items[index-2][this.showMode]));
...
<template>
  <div>
    ...
    <div class="right-radio" style="padding-top:30px" @change="tryToFetchListUnit">
